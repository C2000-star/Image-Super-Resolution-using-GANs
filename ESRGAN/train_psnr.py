...
def main(_):
    ...
    tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir="/content/drive/MyDrive/logs/Ultimate-SR/ESRGAN-MSE-500K-DIV2K/logs, histogram_freq=1)
    print("\n[*] training done!")
